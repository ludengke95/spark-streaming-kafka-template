...
import com.opensharing.bigdata.handler.kafka.KafkaRDDHandler;
...
public class SparkStreamingKafka implements Serializable {
    ...
    private List<KafkaRDDHandler> handlers = new ArrayList<KafkaRDDHandler>();
     ...
     * 传入javaStreamingContext，不支持checkpoint
     * 需设置
     *  1. 启动间隔
    ...
    protected void work() throws Exception {
        ...
        stream.foreachRDD(line->{
            ...
            for (KafkaRDDHandler rddHandler : handlers) {
    ...
    public void addHandler(KafkaRDDHandler rddHandler){
